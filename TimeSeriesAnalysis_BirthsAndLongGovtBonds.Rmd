...
---
title: Births and Long-Term Government Treasury Index
output:
...
dep <- getSymbols(paste(dependent.variable, sep=""), src="yahoo", start=start, end=end)
str(dep)
dep.xts <- as.xts(VLGSX)
#dep.xts <- as.xts(cat(noquote(dep)))
